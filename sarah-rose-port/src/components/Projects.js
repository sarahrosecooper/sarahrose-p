  ...
  return (
    <div className="portfolio">
      <div className="child">
        ...
        <p>
          built with redux, react, css, and styled components on a collaborative
          team of four developers over two weeks.
        </p>
        <a
...
"
      ...
      <div className="child">
        ...
        <p>
          one of my very first projects trying to grasp flexbox and css styling
          in faux portfolio format.
        </p>
        <a
